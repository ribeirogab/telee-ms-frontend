...
interface FormAddUpdatesProps {
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
  updates: Update[];
  setUpdates: React.Dispatch<React.SetStateAction<Update[]>>;
}

const FormAddUpdates: React.FC<FormAddUpdatesProps> = ({
  setOpen,
  updates,
  setUpdates,
}) => {
  ...
  const handleCloseModalAddUpdates = useCallback(() => {
    setOpen(false);
  }, [setOpen]);
    ...
    <>
      ...
      <Container>
        <Form ref={formRef} onSubmit={handleSubmit}>
          <h1>Cadastrar update</h1>

          <Input name="title" icon={FiType} placeholder="Título" />
          <Input
            name="description"
            icon={FiAlignLeft}
            placeholder="Descrição"
          />
          <Input name="version" icon={FiGitCommit} placeholder="Versão" />
          ...
          <ButtonContainer>
            ...
            <Button
              ...
              onClick={handleCloseModalAddUpdates}
            >
              Cancelar
            </Button>
          </ButtonContainer>
